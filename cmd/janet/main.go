...
func main() {
	...
	if len(upvotereactji) == 0 {
		...
		upvotereactji.Set("heart")
		upvotereactji.Set("clap")
		upvotereactji.Set("coffin")
		upvotereactji.Set("fire")
		upvotereactji.Set("heart_on_fire")
		upvotereactji.Set("lol")
		upvotereactji.Set("nail_care")
		upvotereactji.Set("rainbow")
		upvotereactji.Set("rip")
		upvotereactji.Set("skull")
		upvotereactji.Set("sparkles")
		upvotereactji.Set("star-struck")
		upvotereactji.Set("star")
		upvotereactji.Set("star2")
		upvotereactji.Set("thumbsup_all")
		upvotereactji.Set("unicorn_face")
		upvotereactji.Set("yellow_heart")
		upvotereactji.Set("zach-cowboy")
